...
RELEASE_CFLAGS  := -std=c++11 -fopenmp
...
SYS_LIBS        = -lm -lpthread -fopenmp
#SYS_LIBS        = -lm -lopencv_core -lopencv_highgui -lopencv_imgproc
...
LOCAL_LIB_DIR   = $(HOME)/lib /usr/local/lib
